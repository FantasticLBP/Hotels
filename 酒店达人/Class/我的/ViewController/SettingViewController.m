...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.section == 0 && indexPath.row == 0) {
        ...
        if (indexPath.row == 0) {
            ...
            UIAlertController *alert = [UIAlertController alertControllerWithTitle:@"推荐酒店达人给朋友" message:nil preferredStyle:UIAlertControllerStyleActionSheet];
